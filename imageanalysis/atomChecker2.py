...
class atom_window(QMainWindow):
    ...
    Cs_rois         -- list of ROI coordinates (xc, yc, width, height).
    Rb_rois         -- list of ROI coordinates (xc, yc, width, height).
    ...
    def __init__(self, last_im_path='.', Cs_rois=[(1,1,1,1)], Rb_rois=[(1,1,1,1)],

...
class AWG:
    ...
    def loadSeg(self,seg,listChanges):
        """
        ...
        lsegment = lfile['segments']['segment_'+str(seg)]    # segment to be altered.
        lstep = lfile['steps']['step_'+str(seg)]            # step to be reloaded - assumes the convention that segment and step have the same value.
...
if __name__ == "__main__":
    ...
    """
    # multirun = [[1,"freqs_input_[MHz]",[222]],[2,"tot_amp_[mV]",110]]

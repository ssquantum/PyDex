...
class AWG:
    ...
    def load(self,file_dir='Z:\Tweezer\Experimental\AOD\m4i.6622 - python codes\Sequence Replay tests\metadata_bin\\20200906\\20200906_140826.txt'):
        ...
        for i in range(segNumber):
            ...
            for j in lchannels:
                ...
                arguments = [lsegments['segment_'+str(i)]['channel_'+str(j)][x] for x in self.loadOrder[actionUsed]]
        ...
        for i in range(stepNumber):
            stepArguments = [lsteps['step_'+str(i)][x] for x in self.stepOrder]
    ...
    def multiChannel(self,f1,f2,duration):
        ...
        spcm_dwSetParam_i32 (AWG.hCard, SPC_CARDMODE,        SPC_REP_STD_SEQUENCE)  # Sets to Sequence Replay. Check p.66 of manual for list of available modes. 
        spcm_dwSetParam_i64 (AWG.hCard, SPC_CHENABLE,                  qwChEnable)  # Selects the 1st Channel to open.
        spcm_dwSetParam_i32 (AWG.hCard, SPC_SEQMODE_MAXSEGMENTS, self.num_segment)  # The entire memory will be divided in this many segments. I don't think you can easily partition it. 
        spcm_dwSetParam_i32 (AWG.hCard, SPC_SEQMODE_STARTSTEP,   0)  # This is the initialising step for the run.
        ...
        for i in range (0, lSetChannels.value):
            spcm_dwSetParam_i32 (AWG.hCard, SPC_AMP1 + i * (SPC_AMP1 - SPC_AMP0), int32 (AWG.max_output))
            spcm_dwSetParam_i32 (AWG.hCard, SPC_ENABLEOUT1 + i * (SPC_ENABLEOUT1 - SPC_ENABLEOUT0),  int32(1))
        
        
        spcm_dwSetParam_i32(AWG.hCard, SPC_SEQMODE_WRITESEGMENT,0)
        spcm_dwSetParam_i32(AWG.hCard, SPC_SEQMODE_SEGMENTSIZE, self.numOfSamples)
...
if __name__ == "__main__":
    ...
    seg=0
    data01 = t.dataGen(seg,ch1,"ramp",0.02,[166],1,9, 110,[1],[1],[0],False,False) #seg0, channel 1 - Cs
    data02 = t.dataGen(seg,ch1,"ampMod",0.02,[166],1,9, 110,[1],140,0.1,[0],False,False) #seg0, channel 1 - Cs
    t.setSegment(seg,data01,data02)
    ...
    """
#     data01 = t.dataGen(0,ch1,'static',1,[166],1,9, 220,[1],[0],False,False) #seg0, channel 1 - Cs
#     data02 = t.dataGen(0,ch2,'static',1,[166],1,9, 220,[1],[0],False,False) #seg0, channel 2 - Rb
...
#     """
#     dur = 10
#     data11 = t.dataGen(1,ch1,'moving',dur,[160],[180],1,110,[1],[1],[0],False,False) #seg1, channel 1
#     data12 = t.dataGen(1,ch2,'ramp',dur,[166],1,9, 110,[1],[1],[0],False,False)      #seg1, channel 2
